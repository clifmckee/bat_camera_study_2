...
```{r human dropped winter fruit consumption graph, echo=FALSE, fig.align="center", fig.height=5, fig.width=10}
...
```{r bat winter fruit consumption graph, echo=FALSE, fig.align="center", fig.height=5, fig.width=10}
# create a new object where average consumption across village types is ranked
